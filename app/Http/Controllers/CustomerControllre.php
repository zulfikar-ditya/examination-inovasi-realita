...
class CustomerControllre extends Controller
{
    public string $folder = 'customer';
    /**
    ...
    public function create()
    {
        ...
        return view('pages.'.$this->folder.'.create', compact('model', 'customer_types'));
    }
    ...
    public function edit($id)
    {
        $model = model::findOrFail($id);
        $customer_types = CustomerType::all();
        return view('pages.'.$this->folder.'.edit', compact('model', 'customer_types'));
    }
